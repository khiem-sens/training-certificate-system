...
function PopupNotification({
  ...
  return (
    <>
      ...
      <section className=' w-[700px] h-auto fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 flex items-start p-6 bg-white rounded border border-[#DDDDDD] shadow-lg'>
        <img
          loading='lazy'
